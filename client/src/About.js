  ...
  return (
    <Card className="Background1" border="light">
      <Container style={{ maxWidth: "1000px", padding: "20px 30px" }}>
        ...
        <Card.Body>
          <h4 className="face1">
            Bag World was made by Tom Kondat on Web Development course.
          </h4>
          <br></br>
          <h5>
            Bag World is an online bag store that gives our customers the best
            bags you can find.
          </h5>
          <h5>
            {" "}
            We have good prices and free Shipping over 200$ (not inclued taxes).
          </h5>
          <br></br>
          <h5>Follow our Instagram profile to keep up with new updates.</h5>
          <hr />
          <h5 className="face">
            {" "}
            Our Facebook and Twitter profiles are under maintenance and will be
            back soon.
          </h5>
          <br></br>
          <br></br>
