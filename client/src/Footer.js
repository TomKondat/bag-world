      ...
      <CDBFooter className="shadow">
        ...
        >
          <CDBBox display="flex" alignItems="center">
            ...
            <Container>
              <span className="ml-4 h5 mb-0 font-weight-bold">Bag World</span>

              <small className="ml-2">
                &copy; Bag World, 2022. All rights reserved.
              </small>
            </Container>
          </CDBBox>
          <CDBBox display="flex">
            <CDBBtn
              ...
              className="p-2"
              href="https://www.instagram.com/bag__worldd/"
            >
              <CDBIcon fab icon="instagram" />
            </CDBBtn>
            <CDBBtn flat color="info" className="mx-3 p-2" disabled>
              <CDBIcon fab icon="twitter" />
            </CDBBtn>
            <CDBBtn flat color="primary" className="p-2" disabled>
